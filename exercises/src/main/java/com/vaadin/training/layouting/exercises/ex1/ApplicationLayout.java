...
public class ApplicationLayout extends VerticalLayout implements HasUrlParameter<String> {
	...
	public ApplicationLayout() {
		setPadding(false);
		setSpacing(false);
		setSizeFull(); //Definindo o tamanho do layout (stretch full)
		setDefaultHorizontalComponentAlignment(Alignment.STRETCH); //(stretch enum de ALIGN é a função que define a responsividade da página
		...
		//Removidos pelo fato da função createTextLayout e createBlock.
